 ...
 * Displays paginated products data with search, sort, and pagination
 */
...
import type { ProductsDataResponse, ProductsDataParams } from '../types';

interface ProductsTableProps {
  data: ProductsDataResponse | undefined;
  isLoading: boolean;
  params: ProductsDataParams;
  onParamsChange: (params: Partial<ProductsDataParams>) => void;
}
    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between pb-4">
        ...
        <div className="relative w-72">
          ...
          <Input
            placeholder="Tìm theo tên, Product ID..."
            value={searchInput}
              ...
              {isLoading ? (
                ...
                data?.data.map((row) => (
                  <TableRow key={row._id}>
                    ...
                    <TableCell
                      className="text-sm text-center max-w-md truncate"
